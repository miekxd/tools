...
export default function CsvProcessorPage() {
  const tool = {
    ...
    webhookUrl: 'https://your-webhook-url.com/csv-processor', // Replace with your actual webhook
    ...
    parameters: [
      ...
      },
      {
        ...
        required: true,
        options: ['filter', 'transform', 'analyze', 'merge']
      },
      {
        name: 'filters',
              ...
              <div className="max-w-4xl mx-auto space-y-8">
                  ...
                  <div className="mt-8 pt-6 border-t" style={{ borderColor: 'var(--border-primary)' }}>
                    ...
                    {!isFormValid() && (
                      <p className="mt-2 text-sm" style={{ color: 'var(--text-secondary)' }}>
                        Please fill in all required fields to process the CSV.
                      </p>
                    )}
                  </div>
                </div>
                ...
                {webhookResult && (
                  <div className="space-y-4">
                    <h3 className="text-lg font-semibold" style={{ color: 'var(--text-primary)' }}>Processing Result</h3>
                    ...
                    <div className={`border rounded-lg p-4 ${
                      ...
                      {webhookResult.success && webhookResult.data && (
                        <div className="space-y-2">
                          <h4 className="font-medium text-green-800">Processed Data:</h4>
