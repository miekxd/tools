        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="border-b px-8 py-6" style={{ borderColor: 'var(--border-primary)' }}>
            ...
            <div className="grid grid-cols-4 gap-4 mt-6">
              <div className="rounded-lg p-4" style={{ backgroundColor: 'var(--bg-secondary)', borderColor: 'var(--border-primary)', borderWidth: '1px' }}>
          ...
          <div className="border-b px-8 py-3 flex items-center justify-between" style={{ 
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-1.5 rounded-md text-sm font-medium transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                            ...
                            <div className="grid grid-cols-2 gap-6">
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  <div className="space-y-1 text-sm" style={{ color: 'var(--text-secondary)' }}>
                                    <div><strong>Insiders:</strong> {call.number_of_insiders || 0}</div>
                                    <div><strong>Total Value:</strong> ${call.total_transaction_value ? (call.total_transaction_value / 1000000).toFixed(2) : '0'}M</div>
                                    <div><strong>Time Horizon:</strong> {call.time_horizon || 'N/A'}</div>
                                    <div><strong>Status:</strong> {call.status || 'N/A'}</div>
                                  </div>
                                </div>
                              ...
                              <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  {call.insider_prices_json.length > 0 ? (
                                    <ul className="list-disc list-inside text-sm space-y-1" style={{ color: 'var(--text-secondary)' }}>
                                      {call.insider_prices_json.map((price, idx) => (
                                ...
                                <div>
                                  ...
                                  <div className="space-y-1 text-xs" style={{ color: 'var(--text-tertiary)' }}>
                                    <div><strong>Batch ID:</strong> {call.batch_id}</div>
                                    <div><strong>Call Date:</strong> {new Date(call.call_date).toLocaleString()}</div>
                                    {call.last_price_update && (
                                      <div><strong>Price Updated:</strong> {new Date(call.last_price_update).toLocaleString()}</div>
                                    )}
                                  </div>
                                </div>
                              </div>
